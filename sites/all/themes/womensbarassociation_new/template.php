 ...
 */
function womensbarassociation_new_new_breadcrumb($variables) {
...
function womensbarassociation_new_theme() {
 return array(
...
function womensbarassociation_new_preprocess_maintenance_page(&$vars) {
  // While markup for normal pages is split into page.tpl.php and html.tpl.php,
  // the markup for the maintenance page is all in the single
  // maintenance-page.tpl.php template. So, to have what's done in
  // womensbarassociation_new_preprocess_html() also happen on the maintenance page, it has to be
  // called here.
  womensbarassociation_new_preprocess_html($vars);
}
...
function womensbarassociation_new_preprocess_html(&$vars) {
  // Toggle fixed or fluid width.
  if (theme_get_setting('womensbarassociation_new_width') == 'fluid') {
 ...
 * Override or insert variables into the html template.
 */
function womensbarassociation_new_process_html(&$vars) {
...
function womensbarassociation_new_preprocess_page(&$vars) {
...
function womensbarassociation_new_preprocess_node(&$vars) {
...
function womensbarassociation_new_preprocess_comment(&$vars) {
...
function womensbarassociation_new_preprocess_block(&$vars) {
...
* Override or insert variables into the page template.
*/
function womensbarassociation_new_process_page(&$vars) {
  // Hook into color.module
  if (module_exists('color')) {
 ...
 */
function womensbarassociation_new_preprocess_region(&$vars) {
  if ($vars['region'] == 'header') {
    $vars['classes_array'][] = 'clearfix';
  }
}
function womensbarassociation_new_date_combo($variables) {
