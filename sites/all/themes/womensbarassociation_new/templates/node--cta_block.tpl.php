...
<?php if(!empty($parent_padding)){ ?>
  <div class="cta_block_parent" style="padding:<?php print $parent_padding; ?>; background:<?php print $bg_color; ?>">
<?php } ?>
<div class="cta_block" style="width:<?php print $block_width ?>; height:<?php print $block_height ?>; border:<?php print $border_width.' '.$border_color ?>; background:<?php print $bg_color ?>; border-radius:<?php print $border_radius ?>; padding-top:<?php print $padding_top ?>; padding-right:<?php print $padding_right ?>; padding-bottom:<?php print $padding_bottom ?>; padding-left:<?php print $padding_left ?>; text-align:<?php print $text_align ?>;">
...
<div class="cta_block" style="width:<?php print $block_width ?>; height:<?php print $block_height ?>; border:<?php print $border_width.' '.$border_color ?>; background:<?php print $bg_color ?>; border-radius:<?php print $border_radius ?>; padding-top:<?php print $padding_top ?>; padding-right:<?php print $padding_right ?>; padding-bottom:<?php print $padding_bottom ?>; padding-left:<?php print $padding_left ?>; text-align:<?php print $text_align ?>; font-weight:<?php print $font_weight ?>;">
  <h2 class="block_title" style="font-size:<?php print $title_fontsize ?>; color:<?php print $title_color ?>; font-family:<?php print $title_typeface ?>; font-weight:<?php print $font_weight ?>;"><?php print $node_obj->title; ?></h2>
  <?php if(!empty($link_title)){ ?>
    <span class="cta_link">
	 <a href=" <?php print $node_obj->field_link_destination['und'][0]['url'];?>" style="font-size:<?php print $link_fontsize ?>; font-family:<?php print $link_typeface ?>; color:<?php print $link_color ?>;"><?php print $link_title; ?> </a>
