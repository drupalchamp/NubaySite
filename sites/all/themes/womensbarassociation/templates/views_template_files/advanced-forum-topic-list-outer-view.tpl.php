...
<div class="<?php print $classes; ?>">
  ...
  <?php if ($node_create_list): ?>
    <div class="forum-node-create-links forum-node-create-links-top"><?php print $node_create_list ?>
      <div class="forum-add-node forum-add-forum">
      <?php 
	    $val= arg(1);
		$values = taxonomy_get_parents($val);
		foreach($values as $value){ 
		}
		if($value->tid=="6" || $val=="6"){  ?>
			<a class="af-button-large" href="<?php print $base_url; ?>/forums/womens-bar-association">
		<?php } else{ ?>
            <a class="af-button-large" href="<?php print $base_url; ?>/forums/womens-bar-foundation">
        <?php } ?>
