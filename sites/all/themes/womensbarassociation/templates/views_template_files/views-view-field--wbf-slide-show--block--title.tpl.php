...
<div id="slideshow_box">
    ...
    <div class="desc_box">    
    	<div class="title_text"><?php print l($node_obj->title,'node/'.$node_obj->nid); ?></div>
        <div class="desc_text"><?php print l($node_obj->field_short_description['und']['0']['value'],'node/'.$node_obj->nid); ?></div>    
    </div>
</div>
